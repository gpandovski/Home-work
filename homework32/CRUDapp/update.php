...
if(!empty($_GET['id'])) {
    ...
    $user = mysqli_fetch_all($read, MYSQLI_ASSOC);
} else {
...
<body>
    ...
    <div>
    <h1>Update user id : <?= $_GET['id'] ?></h1>
    <form class="needs-validation" action="" method="POST">
        <div class="form-row">
            <div class="col-md-6 mb-3">
            <label for="validationCustom01">First name</label>
            <input type="text" class="form-control" id="validationCustom01" value="<?= $user[0]['firstname']; ?>" name="firstname" required>
            ...
            <input type="text" class="form-control" id="validationCustom02" value="<?= $user[0]['lastname']; ?>" name="lastname" required>
            <div class="valid-feedback">
                Looks good!
            </div>
            </div>
